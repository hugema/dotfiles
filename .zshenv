...
alias gl='git log -n 15 --graph --pretty="%Cred%h%Creset %s %Cgreen(%cr)%Creset%C(yellow)%d%Creset"'
alias glr='git log --reverse --pretty="%Cred%h%Creset %s %Cgreen(%cr)%Creset%C(yellow)%d%Creset"'
alias gll='git log --graph --pretty="%Cred%h%Creset %s %Cgreen(%cr)%Creset%C(yellow)%d%Creset"'
